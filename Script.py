...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/TheInsomniacsClub)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏғ ᴛʜᴇsᴇ?"""
    ...
    I_CUDNT = """<b>sᴏʀʀʏ ɴᴏ ғɪʟᴇs ᴡᴇʀᴇ ғᴏᴜɴᴅ ғᴏʀ ʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ {} 😕

ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇsᴛ ғᴏʀᴍᴀᴛ 👇
Uncharted or Uncharted 2022

sᴇʀɪᴇs / ᴀɴɪᴍᴇ ʀᴇǫᴜᴇsᴛ ғᴏʀᴍᴀᴛ  👇
Loki or Loki S01 or Loki S01E04

ɪғ ᴛʜᴇ ғɪʟᴇs ᴀʀᴇ ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ᴇᴠᴇɴ ᴀғᴛᴇʀ ᴜsɪɴɢ ᴄᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ 
ᴛʜᴇɴ ʀᴇǫᴜᴇsᴛ ᴜs ᴡᴇ ᴡɪʟʟ ᴜᴘʟᴏᴀᴅ ᴀsᴀᴘ</b>"""
...
Any Doubts or Not Connecting? Contact Developer </b>
"""

    REQINFO = """
⚠ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ⚠

ᴀғᴛᴇʀ 5 ᴍɪɴᴜᴛᴇs ᴛʜɪs ᴍᴇssᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ

ɪғ ʏᴏᴜ ᴅᴏ ɴᴏᴛ sᴇᴇ ᴛʜᴇ ʀǫᴜᴇsᴛᴇᴅ ᴍᴏᴠɪᴇs / sᴇʀɪᴇs / ᴀɴɪᴍᴇ ғɪʟᴇs , ʟᴏᴏᴋ ᴀᴛ ᴛʜᴇ ɴᴇxᴛ ᴘᴀɢᴇ """

    SELECT = """
ᴍᴏᴠɪᴇs ➢ sᴇʟᴇᴄᴛ "ʟᴀɴɢᴜᴀɢᴇs"

sᴇʀɪᴇs / ᴀɴɪᴍᴇ ➢ sᴇʟᴇᴄᴛ "sᴇᴀsᴏɴs"

ᴛɪᴘ : sᴇʟᴇᴄᴛ "ʟᴀɴɢᴜᴀɢᴇs" ᴏʀ "sᴇᴀsᴏɴs" ʙᴜᴛᴛᴏɴ"""
