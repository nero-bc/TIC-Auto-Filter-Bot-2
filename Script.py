...
"""
    ...
    REQINFO = """
ɪғ ᴛʜᴇ ғɪʟᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ᴏʀ ᴍᴏʀᴇ ғɪʟᴇs ᴀʀᴇ ᴛᴏ ʙᴇ ᴀᴅᴅᴇᴅ ғᴏʀ ᴍᴏᴠɪᴇs ᴀɴᴅ ɴᴇᴡ sᴇᴀsᴏɴs ғᴏʀ sᴇʀɪᴇs/ᴀɴɪᴍᴇ 

ʀᴇǫᴜᴇsᴛ ᴜs ᴡᴇ ᴡɪʟʟ ᴛʀʏ ᴛᴏ ᴜᴘʟᴏᴀᴅ ᴀs sᴏᴏɴ ᴀs ᴘᴏssɪʙʟᴇ"""
